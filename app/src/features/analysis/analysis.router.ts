...
export const createAnalysisRouter = (
  ...
  createTRPCRouter({
    ...
    getImplementationDocumentation: protectedProcedure
      .input(getImplementationDocumentationSchema)
      .query(async ({ ctx, input }) => {
        try {
    ...
    getStrategyKPIAnalysis: protectedProcedure
      .input(getStrategyKPIAnalysisSchema)
      .query(async ({ ctx, input }) => {
        try {
